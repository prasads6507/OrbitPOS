...
export function PublicFooter() {
  return (
    <footer className="py-20 border-t border-gray-100 bg-white">
      <div className="container px-4 sm:px-8 mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
          <Link href="/" className="flex items-center gap-2 group">
            <Image 
              ...
              width={240} 
              height={80} 
              className="h-12 md:h-16 w-auto transition-all grayscale hover:grayscale-0 opacity-80 hover:opacity-100" 
            />
          </Link>
